...
Using "early exit" with this code had us repeating ourselves _over and over_. We even had to add an additional condition since we couldn't just skip the algorithmic step if it didn't apply.
