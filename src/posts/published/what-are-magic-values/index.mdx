...
subtitle: null
description: ''
excerpt: 'I recently did a code review for an aspring developer and instructed them to &ldquo;get rid of the &lsquo;magic values&rsquo; in their code.&rdquo; It dawned on me that it might not have been obvious what I meant, so I figured I would take a few moments, and paragraphs, to explain.'
tags: ['JavaScript', 'Software Engineering']
relatedPostsSlugs: []
---

I recently did a code review for an aspring developer and instructed them to "get rid of the 'magic values' in their code." It dawned on me that it might not have been obvious what I meant, so I figured I would take a few moments, and paragraphs, to explain.
