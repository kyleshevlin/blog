...
=======
Let's combine this all together into an actual XState machine. Machines receive an `id`, an `initial` state, and a `states` object of the enumerated state nodes.
>>>>>>> dc5a86650dc3499d7ad86f22c8e478aab643edb8
