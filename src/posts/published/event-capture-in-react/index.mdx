...
So... as of the time I'm writing this, I've used React for 7 years and **today** (February 22, 2022) I learned something completely unbeknownst to me. <Marker content="Yes, it took me 4 months to get back to this and write the last few paragragphs, lol." /> **You can append** `Capture` **to an event name to have it handled in the "capture" phase of event delegation, instead of the "bubbling" phase**. Who knew?! It's [right here in the docs](https://reactjs.org/docs/events.html#supported-events).
