...
Our compositions now read left-to-right, top-to-bottom (this is also how the pipeline operator `|>` works in other languages). Forgive me, I had to teach you composition the mathematical way first. Our `pipe` compositions now would look like this:
