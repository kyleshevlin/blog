...
- No ability to add top-level `event`s <Marker index={1} content="Like adding a RESET event to all states in our LightBulb machine by adding a top level <code>on</code> object" />
