...
**Update**: This component was formerly names `Spacer`. It was brought to my attention that a few design systems use `Spacer` in the way of old `spacer.gif`s, arbitrarily sized empty boxes used for pushing elements around. Thus, I've renamed this component to `Margin`. It's more accurate anyways.
