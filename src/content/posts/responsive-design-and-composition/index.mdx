...
**Now look**, I understand why this happens. It's really easy to empathize with the challenge the original dev or devs faced in making this work. They were clever enough to come up with a grid layout that could accommodate their needs.

That said, they made this way harder than it has to be. But how could they have know there is an easier way hidden just below the surface? There are two clues here that make it clear what we should do instead.
