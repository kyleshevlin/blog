...
subtitle: null
description: 'Refactoring is a key part of my development process. Let me show you the <code>git</code> workflow I use to make refactoring a simple part of my feature building process.'
excerpt: null
