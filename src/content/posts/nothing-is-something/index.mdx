...
description: "If this, do that; else, do nothing. A programmer's story as old as time. But what if doing nothing is actually doing something. And what if our code can get a lot simpler by recognizing that?"
excerpt: null
