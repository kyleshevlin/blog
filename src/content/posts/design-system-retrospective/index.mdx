...
But this was a challenge for devs. They we're quick to grasp that the fastest way to have an `inline-block` button was to wrap it in a `Row`. Even _after_ I did multiple demos and wrote examples in our documentation. It never became intuitive for them.
...
It got me thinking. It took me a while to figure it out, but I realized what I would do differently. If I could go back and do it again, I would have built the design system around `Tailwind`/`NativeWind` instead.
