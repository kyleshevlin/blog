...
I first conceived of Agathist in 2017. I bought the domain [agath.ist](https://agath.ist) because I thought the name was perfect for company. It rolls of the tongue. It doesn't hurt that the top level domain for Istanbul is `.ist`. That was icing on the cake.

I even made a placeholder page for it as if I was starting an agency back then. Up to that point I had only worked at agencies, so it was what I knew. But I never did anything with the site other than renew the domain.
...
I also hope to get back to learning and growing. My last job was a poor fit in this regard. It was quagmired. I spent all of my energy pouring into others, trying to build up their skills so we could move forward. No one was pouring into me and there were no opportunities for growth. I became stuck as well. Starting Agathist is part of my journey to getting out of that muck.
...
I'm open to a lot of ideas! My career has had me work on so many different things, I genuinely could help out on a web (or React Native) project in so many ways. Here are a few ways I'm focusing on right now:

#### **Fullstack applications**

I'd love to land some bigger applications with some bigger companies. Projects with some real meat to them. I actually love working on product in the early stages, where there's lots of work to get done and you can really just put your head down and go. Let us build your version 1.0, get you rolling.

#### **Codebase improvement**

I'm thinking of this as "Refactor as a Service". Every place I've worked has needed lots of love. I'm skilled at revitalizing legacy code and making it pleasurable to work in. I'd be happy to bring that to a project.

In addition, I've been approached a couple times now to do "Revamp as a Service", too. If you have a older website that just needs to be ported to something more modern, let us do that. We can set you up on a modern stack you're happy with, with better, faster DX and get you back on the happy path.

#### **Design systems**

I've spent the last 10 years working in React and the last 2 building a design system that supports React and React Native. If you're team has been looking to build one of these but doesn't know how, or just needs help getting started, I'd love to help.

### Is anyone else on the team with you?

Yes! Right now one of my best friends is working with me. <Marker content="I am so excited!" /> This way we'll have enough hands and minds to take on some bigger projects. I'll add subcontractors as necessary this year and hopefully will be able to hire some as full-time employees when the time comes.

### What are Agathist's rates?

Good question! The truth is you can't have one rate for all clients. You need to optimize it for value. Bigger companies, bigger projects that bring in bigger revenues, they're worth more value and thus the rate should be higher to match that value.

That said, I'm a very transparent person, <Marker content="A trait that is <em>also</em> related to my neurodivergence. Yay, oversharing!" /> I'm starting my bids at $125/hour and shooting for no more than 40 hours per week _split_ between my colleague and me. I want to keep our workload very reasonable and give myself ample time pursue new clients and grow the business. I can't do that if I'm full-time coding.
...
If you're really adventurous, you can click the Agathist ads you see around here, too. That will lead you in the right direction.
...
Our main hurdle at the moment is landing those first clients. Once the ball is rolling, we'll have new, exciting challenges to deal with.

Other ways you can help out include:

- Sharing this post
- Sharing the [Agathist website](https://agath.ist)
- Write a testimonial if we've worked together

There are probably even more ways I'm not thinking of right now. Be creative!

### How are you going to conclude this Q&A?

By saying thank you. Thank you to the people who believe that I can do this. Thank you to the mentors helping me learn some lessons the easy way, rather than the hard way. And thank you to the network of wonderful people I have that makes this a possibility. I appreciate every one of you.
