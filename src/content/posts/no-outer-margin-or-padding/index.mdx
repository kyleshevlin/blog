...
One of the most common ways I see this with headings. Let's say I have a component for `H2`s in my codebase:
...
This might seem like a good idea. Headings tend to be in large blocks of text. But what if you want to add metadata around it? What if it's the title of a blog post and you need to put a subtitle right below it, or a date, or timestamp?
