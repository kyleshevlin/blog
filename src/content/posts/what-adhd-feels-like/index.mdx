...
relatedPostsSlugs: ['how-i-built-test-your-focus']
---
...
Sometimes the ADHD brain gets in a mode where it's desperately seeking stimulation, but there's no guarantee that what is tried will produce the dopamine desired.

The person might have a number of go to activities or stimulants, but their effectiveness varies often. Something that brought them a lot of joy and focus yesterday might no longer work, and there's no way to know for how long the activity will do the trick.

The game below simulated this understimulation. Which button will work? And for how long before it no longer works? Try it out.
