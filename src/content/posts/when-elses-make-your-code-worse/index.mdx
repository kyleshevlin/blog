...
<blockquote class="twitter-tweet" data-lang="en">
  <p lang="en" dir="ltr">
    Random, lukewarm (as opposed to hot) take: You really don&#39;t need the
    `else` keyword in JavaScript. Any scenario you&#39;d think to use it, I
    might argue there&#39;s a better, and possibly simpler, way. *searches for
    smoking embers of a former fire emoji*
  </p>
  &mdash; Kyle Shevlin (@kyleshevlin) <a href="https://twitter.com/kyleshevlin/status/1131674209287979008?ref_src=twsrc%5Etfw">May 23, 2019</a>
</blockquote>
<script
  async
