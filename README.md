...
If you are looking for a post, it is somewhere under `src/posts/published`. Doing a search under there will lead you to the post you are looking. My apologies that directory names do not always match the eventual title of the blog. The idea I start writing does not always end up being the same as the finished post.
